...
(function (LightHouse) {
    ...
    //   return innerEdges;
    // }
    LightHouse.solution = (n, lighthouse) => {
        let result = 0;
        while (lighthouse.length > 0) {
            const obj = {};
            for (const [n1, n2] of lighthouse) {
                if (!obj[n1])
                    obj[n1] = 1;
                else
                    obj[n1]++;
            ...
            const mostCountValue = Object.entries(obj).sort(([key1, value1], [key2, value2]) => {
                return value2 - value1;
            })[0][0];
            result++;
            lighthouse = lighthouse.filter(([n1, n2]) => {
                return n1 !== +mostCountValue && n2 !== +mostCountValue;
            });
        }
        return result;
    };
})(LightHouse || (LightHouse = {}));
console.log(LightHouse.solution(8, [
    [1, 2],
    [1, 3],
    [1, 4],
    [1, 5],
...
console.log(LightHouse.solution(10, [
    [4, 1],
    [5, 1],
    [5, 6],
    [7, 6],
